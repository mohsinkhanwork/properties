            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <strong>{{trans('words.customer_details')}}:</strong><br>
                        ...
                        {{ \App\Models\Properties::getPropertyInfo($transaction_info->property_id)->address }}
                    </address>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ \App\Models\Properties::getPropertyInfo($transaction_info->property_id)->property_name }}</td>
